...
\begin{itemize}
	\item Taking gradient of loss function w.r.t input image of the class you want to perturb.
	\item Take your original image and perturb it by a small quantity $\eta$ along the direction of gradient.
	\item Run the model along this result and see the result. 
\end{itemize}  
\end{alertblock}
...
\begin{frame}{Adversarial Training Example}
	\begin{figure}
		\includegraphics[width=0.75\textwidth]{panda-break}
	\end{figure}
\end{frame}
